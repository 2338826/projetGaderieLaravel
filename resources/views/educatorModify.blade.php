...
@section('title', 'Modifier un educateur')

@section('content')
    <div class="container mt-5">
        <h1 class="mb-4">Modifier un educateur</h1>
        ...
        <form action="{{ route('educator.update', $educator->id) }}" method="POST">
            ...
            <div class="row mb-3">
                <div class="col-md-6">
                    ...
                    <input type="text" name="name" id="name" class="form-control" value="{{ old('name', $educator->name) }}"
                        readonly>
                    @error('name')
            ...
            <div class="row mb-3">
                <div class="col-md-6">
                    ...
                    <input type="text" name="firstName" id="firstName" class="form-control"
                        value="{{ old('firstName', $educator->firstName) }}" readonly>
                    @error('firstName')
                        <div class="text-danger mt-1">{{ $message }}</div>
                    @enderror
                </div>
            ...
            <div class="row mb-3">
                <div class="col-md-6">
                    ...
                    <input type="text" name="birth_date" id="birth_date" class="form-control"
                        value="{{ old('birth_date', $educator->birth_date) }}" readonly>
                    @error('birth_date')
                        <div class="text-danger mt-1">{{ $message }}</div>
                    @enderror
                </div>
            ...
            <div class="row mb-3">
                <div class="col-md-6">
                    ...
                    <input type="text" name="address" id="address" class="form-control"
                        value="{{ old('address', $educator->address) }}" required>
                    @error('address')
                        <div class="text-danger mt-1">{{ $message }}</div>
                    @enderror
                </div>
            ...
            <div class="row mb-3">
                <div class="col-md-6">
                    ...
                    <input type="text" name="city" id="city" class="form-control" value="{{ old('city', $educator->city) }}"
                        required>
                    @error('city')
                        <div class="text-danger mt-1">{{ $message }}</div>
                    @enderror
                ...
                <div class="col-md-6">
                    ...
                    <select name="id_state" id="id_state" class="form-select" required>
                        ...
                        @foreach($states as $state)
                                        <option value="{{ $state->id }}" {{ old('id_state', $educator->id_state) == $state->id ? 'selected' :
                            '' }}>
                                            {{ $state->description }}
                                        </option>
                        @endforeach
            ...
            <div class="row mb-3">
                <div class="col-md-6">
                    ...
                    <input type="text" name="phone" id="phone" class="form-control"
                        value="{{ old('phone', $educator->phone) }}" required>
                    @error('phone')
                        <div class="text-danger mt-1">{{ $message }}</div>
                    @enderror
                </div>
